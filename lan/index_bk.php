...
.sidealt{
   ...
   <body  onload="myFunction()" style="background-color:#0d0d0d;">
      <div id="d" class="verticalcenter">
         ...
         <br>
         <div id="mesg">
            <b>Your recluse from limited Internet Access<br><br><span style="color:#FD4815;" id="server">One moment please...</span></b><b><br><br><span style="color:#03A9F4;font-size:14px;"><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Mr. Robot S02 EP11 & Suicide Squad is available now.</span><br><br><span style="font-size:12px;color:#fff;">More movies will be uploaded shortly...</span>
         </div>
         </div>
      </div>
      <!--Navigation-->
               ...
               <div class="carousel-caption">
                  <div class="verticalcenter">
                     <div class="animated fadeInDown">
                        ...
                        <h4>#Season_Finale</h4>
                        <h5>Watch Mr. Robot S02 EP11 [Part-I]</h5>
      ...
      <main class="mdl-layout__content"  id="maic">
         ...
         <br>
               <h5 style="color:#666666;">Movies</h5>
                          ...
                          <div class="row" id="ssjhfjhdaf">
                          <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="bba">
                  <figure>
                     <img src="clip/ss.jpg"  class="img-responsive" id="cmsnnmbdbnv"/>
                     <br>
                     <figcaption style="color:white;" id="dsnbnjaskjfkabvnbj">Suicide Squad</figcaption>
                  </figure>
               </div>
            ...
            <div class="row">
               ...
               <h5 style="color:#666666;">Recently Added</h5>
                          ...
                          <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="bba">
                  <figure>
                     <img src="clip/mr.jpg"  class="img-responsive" id="cmsndbnv"/>
                     <br>
                     <figcaption style="color:white;" id="dsnjaskjfkabvnbj">Mr. Robot S02 - EP11</figcaption>
                  </figure>
               </div>
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="goth">
                  <figure>
                     <img src="clip/nc.jpg"  class="img-responsive" id="cmnv"/>
                     <br>
                     <figcaption style="color:white;" id="dsnfkabvnbj">Narcos S02</figcaption>
                  </figure>
               </div>
