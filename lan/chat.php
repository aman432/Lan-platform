...
<div class="sidealt" id="snv" ><i class="fa fa-chevron-right fa-lg" aria-hidden="true" style="color:white;"></i></div>
      ...
      <main class="mdl-layout__content"  id="maic">
         <div class="container" >
            <div class="row">
               <br>
               <h5 style="color:#666666;">Trending now</h5>
            </div>
            <div class="row" id="sf">
               ...
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="goth">
                  <figure>
                     ...
                     <br>
                     <figcaption style="color:white;" id="dsafvdf">Game of Thrones</figcaption>
                  </figure>
               </div>
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="frnd">
                  <figure>
                     <img src="clip/frn.jpg"  class="img-responsive" id="sdvsa"/>
                     <br>
                     <figcaption style="color:white;" id="erwfe">Friends</figcaption>
                  </figure>
               </div>
            ...
            <div class="row" id="afda">
               ...
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="pb">
                  <figure>
                     <img src="clip/pb.jpg"  class="img-responsive" id="ccfc"/>
                     <br>
                     <figcaption style="color:white;" id="cerce">Prison Break</figcaption>
                  </figure>
               </div>
               ...
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="mm">
                  <figure>
                     <img src="clip/md.jpg"  class="img-responsive" id="sdc"/>
                     <br>
                     <figcaption style="color:white;" id="hfhfhf">Mad Men</figcaption>
                  </figure>
               </div>
            </div>
            <div class="row" >
            ...
            <div class="row" id="puy">
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="got">
                  <figure>
                     <img src="clip/got.jpg"  class="img-responsive" id="sa"/>
                     <br>
                     <figcaption style="color:white;" id="ppqss">Game of Thrones S06 Ep01</figcaption>
                  </figure>
               </div>
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="cl">
                  <figure>
                     <img src="clip/hocr.jpg"  class="img-responsive" id="uyi"/>
                     <br>
                     <figcaption style="color:white;" id="onyc">House of Cards S04</figcaption>
                  </figure>
               </div>
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="clp"  >
                  <figure>
                     <img src="clip/mr.jpg"  class="img-responsive"  id="fdj"/>
                     <br>
                     <figcaption style="color:white;" id="mrr">Mr. Robot</figcaption>
                  </figure>
               </div>
            ...
            <div class="row" id="sdfafa">
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="show">
                  <figure>
                     <img src="clip/rp.jpg"  class="img-responsive" id="sdafcs"/>
                     <br>
                     <figcaption style="color:white;" id="lapqmz">Russell Peters Show</figcaption>
                  </figure>
               </div>
            </div>
            ...
            <div class="row" id="jsas">
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="dm1">
                  <figure>
                     <img src="clip/hmd.jpg"  class="img-responsive" id="sdacsa"/>
                     <br>
                     <figcaption style="color:white;" id="ksjdhf">House</figcaption>
                  </figure>
               </div>
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="dxtr">
                  <figure>
                     <img src="clip/dx.jpg"  class="img-responsive" id="km"/>
                     <br>
                     <figcaption style="color:white;" id="pqoxm">Dexter</figcaption>
                  </figure>
               </div>
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="pb1">
                  <figure>
                     <img src="clip/pb.jpg"  class="img-responsive" id="mkm"/>
                     <br>
                     <figcaption style="color:white;" id="skalo">Prison Break</figcaption>
                  </figure>
               </div>
            ...
            <div class="row">
               <h5 style="color:#666666;">Upcoming</h5>
            </div>
            <div class="row" id="fdavsfdv">
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;" id="up1">
                  <figure>
                     <img src="clip/hocr.jpg"  class="img-responsive" id="asdsdf"/>
                     <br>
                     <figcaption style="color:white;" id="hfhf">House of Cards</figcaption>
                  </figure>
               </div>
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;">
                  <figure>
                     <img src="clip/hocr.jpg"  class="img-responsive"/>
                     <br>
                     <figcaption style="color:white;" id="pzpaka">House of Cards</figcaption>
                  </figure>
               </div>
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;">
                  <figure>
                     <img src="clip/hocr.jpg"  class="img-responsive"/>
                     <br>
                     <figcaption style="color:white;" id="slqslqz">House of Cards</figcaption>
                  </figure>
               </div>
               <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;">
                  <div class="view overlay hm-black-slight">
                     <figure>
                        <img src="clip/hocr.jpg"  class="img-responsive" />
                        <figcaption style="color:white;">House of Cards</figcaption>
                     </figure>
                     <div class="mask">
                        <div class="verticalcenter">
                           <p class="white-text text-center">Watch</p>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <footer class="page-footer   rgba-black-light">
            <div class="container-fluid">
               <div class="row">
                  <div class="col-md-12">
                     <p class="grey-text text-lighten-6" style="font-size: 15px;"><b>&copy 2016 JRadioLAN.<img src="jr_logog.png" class="img-responsive" height="50" width="120" style="float:right;"/></b></p>
                     <p class="grey-text text-lighten-6" style="font-size: 14px;"><span >About</span>  &nbsp;&nbsp;&nbsp;&nbsp;Team     &nbsp;&nbsp;&nbsp;&nbsp;Feedback</p>
                  </div>
               </div>
            </div>
         </footer>
      ...
      <script>
         ...
         $("#cl,#goth,#pb,#frnds,#dxtr").click(function(){
        ...
        scrollTop: $("#"+id).offset().top
          ...
          $("#clp,#ncr,#svl,#pb1,#frnd").click(function(){
              var id = $(this).parent().attr("id");
              var fig = $(this).find("figcaption");
              var attrID1 = fig.attr("id");  
              var txt=$("#"+attrID1).text();
        ...
        scrollTop: $("#"+id).offset().top
           ...
           $("#got,#bba,#sher,#far,#him,#show,#dm1,#dm2,#up1").click(function(){
              var id = $(this).parent().attr("id");   
              var fig = $(this).find("figcaption");
              var attrID1 = fig.attr("id");  
              var txt=$("#"+attrID1).text();    
