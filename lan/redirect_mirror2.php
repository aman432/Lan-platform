      ...
      <main class="mdl-layout__content">
         <div  class="container" >
            ...
            <div class="row">
               ...
               <div id="video-wrapper" class="img-responsive"></div>
               
                  <div id="video-box"><div id="ply"></div></div>
                  <br>
                          <center>                                                             
...
$(document).ready(function(){
  $("#list").animate({ scrollTop: $(document).height() }, 1000);
	var sg=$("#sr").text()+"/"+$("#son").text()+"/Episode 10.mp4";
	var sub=$("#sr").text()+"/"+$("#son").text()+"/Episode 10.vtt";

	var c=$("#sr").text()+"/"+$("#son").text();$("#epod").text("EP10");playVideo('video-box',sg,sub);
